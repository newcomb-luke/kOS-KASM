...
impl Instruction {
    ...
    pub fn operands_from_opcode(opcode: u8) -> Vec<Vec<OperandType>> {
        match opcode {
            ...
            0x4a => vec![],
            0x4b => vec![],
            0x4c => vec![vec![OperandType::STRING], vec![OperandType::STRING, OperandType::INT16, OperandType::INT32]],
            0x4d => vec![vec![OperandType::INT16]],
            0x4e => vec![vec![OperandType::NULL, OperandType::BOOLEANVALUE, OperandType::BYTE, OperandType::INT16, OperandType::SCALARINT, OperandType::SCALARDOUBLE, OperandType::STRING, OperandType::STRINGVALUE, OperandType::ARGMARKER]],
            0x4f => vec![],
            0x50 => vec![],
            0x51 => vec![],
            0x52 => vec![],
