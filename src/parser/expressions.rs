...
impl ExpressionParser {
    pub fn parse_expression(token_iter: &mut Peekable<Iter<Token>>) -> Result<Option<ExpNode>, Box<dyn Error>> {
    ...
    pub fn parse_logical_or(token_iter: &mut Peekable<Iter<Token>>) -> Result<ExpNode, Box<dyn Error>> {
    ...
    pub fn parse_logical_and(token_iter: &mut Peekable<Iter<Token>>) -> Result<ExpNode, Box<dyn Error>> {
    ...
    pub fn parse_equality_exp(token_iter: &mut Peekable<Iter<Token>>) -> Result<ExpNode, Box<dyn Error>> {

        let mut lhs = ExpressionParser::parse_relational_exp(token_iter)?;

        while token_iter.peek().is_some() && (match token_iter.peek().unwrap() {
            Token::EQ => true,
            Token::NE => true,
            _ => false,
        }) {
    ...
    pub fn parse_relational_exp(token_iter: &mut Peekable<Iter<Token>>) -> Result<ExpNode, Box<dyn Error>> {
    ...
    pub fn parse_additive_exp(token_iter: &mut Peekable<Iter<Token>>) -> Result<ExpNode, Box<dyn Error>> {
